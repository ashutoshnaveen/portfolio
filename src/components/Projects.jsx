...
const aimlProjects = [
  ...
  },
  {
    ...
    icon: Gamepad2,
    color: 'green',
    description: 'Interactive Wumpus World from Russell & Norvig\'s AI: A Modern Approach. Two AI agents (KB logic + probabilistic) solve the cave autonomously. Shadow AI tracks player moves and generates a post-game report card with grading and study suggestions. Single HTML file, zero dependencies, works offline as a PWA.',
    highlights: ['Propositional logic KB inference engine', 'Shadow AI gameplay analysis with A-F grading', 'Probabilistic agent with pit/wumpus overlays', '17 test suites, 7000+ automated game worlds', 'Offline PWA support on iOS, Android, desktop'],
